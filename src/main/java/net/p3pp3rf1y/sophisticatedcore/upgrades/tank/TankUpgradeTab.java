...
public class TankUpgradeTab extends UpgradeSettingsTab<TankUpgradeContainer> {
	...
	protected void moveSlotsToTab() {
		...
		positionSlot(slots.get(TankUpgradeWrapper.INPUT_SLOT), screen.sophisticatedLibrary_getGuiLeft(), screen.sophisticatedLibrary_getGuiTop(), 4);
		positionSlot(slots.get(TankUpgradeWrapper.OUTPUT_SLOT), screen.sophisticatedLibrary_getGuiLeft(), screen.sophisticatedLibrary_getGuiTop(), 25);
	}
