...
public class TankUpgradeTab extends UpgradeSettingsTab<TankUpgradeContainer> {
	...
	protected void moveSlotsToTab() {
		...
		positionSlot(slots.get(TankUpgradeWrapper.INPUT_SLOT), screen.sophisticatedFabricLibrary_getGuiLeft(), screen.sophisticatedFabricLibrary_getGuiTop(), 4);
		positionSlot(slots.get(TankUpgradeWrapper.OUTPUT_SLOT), screen.sophisticatedFabricLibrary_getGuiLeft(), screen.sophisticatedFabricLibrary_getGuiTop(), 25);
	}
