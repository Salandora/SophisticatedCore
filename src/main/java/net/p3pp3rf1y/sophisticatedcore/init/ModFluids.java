...
public class ModFluids {
	...
	public static final TagKey<Fluid> EXPERIENCE_TAG = TagKey.create(Registry.FLUID.key(), EXPERIENCE_TAG_NAME);
	...
	public static <T extends Fluid> T register(String id, T value) {
		return Registry.register(Registry.FLUID, SophisticatedCore.getRL(id), value);
	}
	...
	public static void registerHandlers() {
		FluidVariantAttributes.register(XP_STILL, new FluidVariantAttributeHandler() {
			...
			public Component getName(FluidVariant fluidVariant) {
				return Component.translatable(Util.makeDescriptionId("fluid", Registry.FLUID.getKey(fluidVariant.getFluid())));
			}
		});
	}
}
