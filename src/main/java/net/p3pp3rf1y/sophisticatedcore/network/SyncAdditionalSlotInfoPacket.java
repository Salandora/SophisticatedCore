...
public class SyncAdditionalSlotInfoPacket implements FabricPacket {
	public static final PacketType<SyncAdditionalSlotInfoPacket> TYPE = PacketType.create(new ResourceLocation(SophisticatedCore.MOD_ID, "sync_additional_slot_info"), SyncAdditionalSlotInfoPacket::new);
